...
@Injectable()
export class SpxTramavandonSource implements TrackingSource {
  readonly name = 'tramavandon-spx';
  private readonly carrierName = 'SPX Express';

  constructor(private readonly config: ConfigService) {}

  isEnabled(): boolean {
    return this.config.get<boolean>('SPX_TRAMAVANDON_SOURCE_ENABLED', true);
  }
